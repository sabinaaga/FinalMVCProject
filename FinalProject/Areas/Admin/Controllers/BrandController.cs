...
namespace FinalProject.Areas.Admin.Controllers
{
    ...
    public class BrandController : Controller
    {
        ...
        public BrandController(ApDbContext dbContext,
        ...
        {
            var datas = await _context.Brands.Select(m => new BrandVM
        ...
        public async Task<IActionResult> Detail(int? id)
        {
            ...
            var datas = await _context.Brands.FirstOrDefaultAsync(m => m.Id == id);
